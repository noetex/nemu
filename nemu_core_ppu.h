#define INTERRUPT_CYCLES_LATENCY 7
...
typedef struct
{
	...
	uint8_t NamTables[0x1f00];
	uint8_t Palletts[0x100];
	uint8_t Mirrors[0x10000 - 0x4000];
} nes_ppu_memory_map;

static_assert(sizeof(nes_ppu_mrmoy_map) == 0x10000);
...
static color_rgb COLOR_PALETTE[64] =
{
...
static_assert(sizeof(COLOR_PALETTE) == (sizeof(color_rgb) * 64));
